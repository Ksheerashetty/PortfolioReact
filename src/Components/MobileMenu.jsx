export const MobileMenu = ({ isMenuOpen, setIsMenuOpen }) => {
  return (
    <div
      className={`fixed top-0 left-0 w-full bg-black z-40 flex flex-col items-center justify-center transaction-all duration-1000 ease-in-out ${
        isMenuOpen
    ...
    >
      ...
      <div className="flex flex-col gap-30 font-extrabold text-2xl text-purple-700">
        <a
          href="#home"
          onClick={() => setIsMenuOpen(false)}
          className={`hover:text-black hover:[text-shadow:_-1px_-1px_0_#c084fc,_1px_-1px_0_#c084fc,_-1px_1px_0_#c084fc,_1px_1px_0_#c084fc,_0_0_10px_rgba(192,132,252,0.8)]
